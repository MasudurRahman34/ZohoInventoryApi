...
trait HasUuids
{
    ...
    public static function bootHasUuids()
    {
        static::creating(function (self $model) {
            ...
            //     }
            // } 
            $model->uuid = $model->newUniqueId();  //change for prevent hiding primary key on data retriving
        });
    }
    ...
    public function uniqueIds()
    {
        ...
        return ['uuid']; //change for prevent hiding primary key on data retriving
    }
