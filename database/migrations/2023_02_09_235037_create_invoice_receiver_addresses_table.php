...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_receiver_addresses', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('company_info')->default(NUll)->nullable()->comment('company/reciever info');
    ...
    {
        Schema::dropIfExists('invoice_receiver_addresses');
    }
};
